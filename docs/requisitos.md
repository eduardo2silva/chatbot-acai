...
|	RF02 | Escolher o produtos | Permitir que o usuário selecione um ou mais produtos do cardápio apresentado. Esse requisito é necessário para viabilizar a composição do pedido de acordo com a preferência do cliente. |
